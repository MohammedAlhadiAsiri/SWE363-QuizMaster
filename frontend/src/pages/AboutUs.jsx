        ...
        <div id={root.root}>
            ...
            <div className={styles.main_container_about}>
                ...
                <p className={styles.para}>
                    At <span className={styles.quiz_master}>QuizMaster</span>,
                    we blend fun with learning, providing an enjoyable way to
                    test your knowledge on a variety of topics. Whether you’re
                    preparing for an exam or just looking to have fun, our
